...
1. Explain the difference between Relational Databases and SQL.
   RD's are the management system, the software that stores the databases. SQL is the query language that we use to modify, delete, add, and view tables (amont other things).
2. Why do tables need a Primary Key?
   To avoid confusion with any other values. Makes for better storage and less ambiguity.
